...
export const Article = async ({ project }) => {
    ...
    return (
        <article className="p-4 md:p-8">
            ...
            <Link href={appLink}>
                <h2 className="z-20 text-xl mt-2 font-medium duration-1000 lg:text-3xl text-zinc-200 group-hover:text-white font-display cursor-pointer" title={`Click to view the ${project.homepage ? 'app' : 'repo'}.`}>
            ...
            {/* <div className="flex justify-between gap-2 items-center pt-2 pb-4 float-left mt-2 border-t-2 border-gray-700 border-opacity-50">
                <span className="text-zinc-500 text-xs flex items-center gap-1">
                    {views}
                    {" "}
                    {alerts}
            ...
            <div className="flex justify-between gap-2 items-center float-left mt-6 border-t-2 pt-2 pb-4 border-gray-700 border-opacity-50">
